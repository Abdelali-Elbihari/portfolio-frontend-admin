            ...
            <div className='container'>
              <div className='row '>
                <div className='col-md-12 col-lg-12 mt-4'>
                  <h2 className='login-heading mb-4 text-center text-danger mb-5'>Login to Admin Panel </h2>
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='form-label-group mb-4'>
                      ...
                      {errors.email && errors.email.type === 'required' && (
                        <div className='text-danger ms-4'>You must enter your email</div>
                      )}
                      {errors.email && errors.email.type === 'pattern' && (
                        <div className='text-danger ms-4'>You must enter a valid email</div>
                      )}
                    </div>
                    ...
                    <div className='form-label-group mb-5'>
                      ...
                      {errors.password && errors.password.type === 'required' && (
                        <div className='text-danger ms-4 fs-6'>You must enter your password</div>
                      )}
                    </div>
